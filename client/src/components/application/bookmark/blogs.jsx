        ...
        <Row>
          ...
          <Col sm="6">
            <div className="pull-right">
              <a className="btn btn-primary" href={`${process.env.PUBLIC_URL}/dashboard/${localStorage.getItem("role")}/add-blog/`}>Add New</a>
            </div>
          </Col>
        </Row>
                  ...
                  {blogDetails.map((item , i) => (
                   <tr key={i}>
                     ...
                     <td className="text-right">
                       <a className="btn btn-success" href={`${process.env.PUBLIC_URL}/dashboard/${localStorage.getItem("role")}/edit-blog/${item.id}/`}>Edit</a> &nbsp;
