        ...
        <Fragment>
            <div className="page-wrapper">
                ...
                <Container>
                    ...
                    <Link to={`${process.env.PUBLIC_URL}/dashboard/vendor/`}><Button color="danger-gradien" size='lg'>{'BACK TO DASHBOARD'}</Button></Link>
                </Container>
                </div>
            </div>
        </Fragment>
